              ...
              <div>
                <div class="flex items-center gap-2">
                  <div class="text-sm font-semibold text-slate-900">
                    <a href="/delegues/view?id=<?= (int) $rep['id'] ?>" class="hover:text-blue-600 hover:underline">
                      <?= htmlspecialchars($rep['name'], ENT_QUOTES, 'UTF-8') ?>
                    </a>
                  </div>
                  <?php if (!empty($rep['car_make']) && !empty($rep['car_model'])): ?>
                    <i class="fas fa-car text-slate-400" title="<?= htmlspecialchars($rep['car_make'] . ' ' . $rep['car_model'], ENT_QUOTES, 'UTF-8') ?>"></i>
                  <?php endif; ?>
                </div>
